...
if st.session_state.get('authenticated', False):
    ...
    row1_col1, spacer, row1_col2 = st.columns([8, 4.0, 20]) # Adjust the middle value to increase or decrease space
    with row1_col1:
    ...
    row2_col1, spacer, row2_col2 = st.columns([12, 4.0, 20])  # Adjust the middle value to increase or decrease space
    with row2_col1:
